...
export async function generateTechnicalDocumentation() {
  ...
  addText('Le système intègre une "Corbeille de Sécurité". Toute transaction supprimée est archivée de façon permanente avec l\'horodatage de suppression, l\'ID de l\'auteur et le motif de suppression. Le solde de l\'école est recalculé en temps réel en fonction des revenus (scolarité) et dépenses (salaires, charges).');
  ...
  (doc as any).autoTable({
    ...
    theme: 'grid',
    headStyles: { fillStyle: [227, 30, 36] }
  });
